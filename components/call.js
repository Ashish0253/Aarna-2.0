...
export default function Call() {
  return (
    <div className="bg-white border-2 border-transparent rounded-2xl grid grid-cols-5 mx-[15%] my-20  shadow-lg">
      <div className="flex font-bold text-primary text-3xl col-span-2">
      ...
      <div className="grid justify-end pr-10 col-span-3 p-5">
        ...
        <button className="flex justify-center border-2 border-transparent bg-primary text-white rounded-lg p-2">
