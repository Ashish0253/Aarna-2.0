...
export default function Call() {
  return (
    <div className="bg-white border-2 border-transparent rounded-2xl flex-col grid  sm:grid-cols-5 mx-[15%] my-20  shadow-lg">
      ...
      <div className="grid justify-end pr-10 col-span-3 p-5">
        ...
        <button className="flex-row sm:flex justify-center border-2 border-transparent bg-primary text-white rounded-lg p-2">
