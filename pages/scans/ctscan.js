...
export default function ctscan(){
    ...
    return(
      ...
      <div className="sm:col-span-2">
            ...
            <p className="text-sm">Computed tomography or CT/CAT scan is a commonly ordered image diagnostic test that combines X-ray images from several angles and compiles them into a single image using 2D and 3D image reconstruction.
...
The contrast material is especially useful when testing soft tissue, as it blocks the X-rays, which makes the target area appear white on the scan. It has little to no side effects and gets flushed out via urine in 24 hours.</p>
        </div>
